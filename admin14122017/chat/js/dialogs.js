...
function getDialogIcon (dialogType) {
  var groupPhoto = '<img src="http://18.221.70.138/medical/assest/chat/images/ava-group.svg" width="40" height="30" class="round">';
  var privatPhoto  = '<img src="http://18.221.70.138/medical/assest/chat/images/ava-single.svg" width="30" height="30" class="round">';
...
function joinToNewDialogAndShow(itemDialog) {
  ...
  if (itemDialog.type != 3) {
    ...
    opponentLogin = getUserLoginById(opponentId);
    dialogName = chatName = dialogName;
  }
