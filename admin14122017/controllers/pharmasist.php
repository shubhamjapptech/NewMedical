...
class Pharmasist extends CI_Controller 

{
	...
	function __construct() {
	 ...
	 public function get_pharmasist()
	 ...
	 public function add_pharmasist()
	 {

	 	$this->load->view('add_pharmasist');
	 }

	 public function insert_pharmasist()
	 {
	 	$data= new stdClass();
					...
					else
					{
						...
						else
						{
					    	...
					    	if($res!=false)
					    	{
					    		...
					    		$data->error=0;
								$data->success=1;
								$data->message="Pharmacist has been added successfully".$enpass.' '.$password;
								$this->load->view('add_pharmasist',$data);
	...
	public function update_pharmasist()
	{
	...
	public function delete_pharmasist()
	{
		$data=new stdClass();
		$id=$_GET['id'];
