        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <!--li class="<!?php if(isset($page) && $page=='one'){ echo 'active';}?>">
                        <a href="<!?php echo base_url('index.php/admin/analytics');?>"><span class="fa fa-desktop"></span> <span class="xn-text">Dashboard</span></a>                        
                    </li--> 
                    ...
                    <li class="xn-openable <?php if(isset($page) && $page=='two'){ echo 'active';}?>">
                        <a href="<?php echo site_url('User/userlist');?>"><span class="fa fa-user"></span> <span class="xn-text">User List</span><label class="badge" id="rowcount1" style="background-color:green !important; margin-left: 10px; border-radius:90% !important"></label></a>
                        <ul>
                    ...
                    <li class="xn-openable <?php if(isset($page) && $page=='three'){ echo 'active';}?>">
                        <a href="<?php echo site_url('Pharmacist/get_pharmacist');?>"><span class="fa fa-table"></span> <span class="xn-text">Pharmacist</span></a>
                        <ul>                            
                    ...
                    <li class="xn-envlop <?php if(isset($page) && $page=='seven'){ echo 'active';}?>">
                     ...
                     <li class="xn-envlop <?php if(isset($page) && $page=='Goodrx'){ echo 'active';}?>">
                        <a href="<?php echo site_url('User/GoodRx');?>"><span class="fa fa-comments-o" aria-hidden="true"></span><span class="xn-text">GoodRx</span></a>
                    </li> 
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-profile">
                        <a href="#" class="profile-mini">
                            <img src="<?php echo base_url('assest/Icon.png');?>">
                        </a>
                        <div class="profile">
                            <div class="profile-image">
                                <img src="<?php echo base_url('assest/Icon.png');?>"/>
                    ...
                    <li class="xn-envlop <?php if(isset($page) && $page=='five'){ echo 'active';}?>">
                        <a href="<?php echo site_url('PrescriptionControler');?>"><span class="fa fa-pencil"></span><span class="xn-text">Prescription Verification</span></a>
                    </li> 

                    <li class="xn-envlop <?php if(isset($page) && $page=='nine'){ echo 'active';}?>">
                        <a href="<?php echo site_url('PrescriptionControler/renew_prescription');?>"><span class="fa fa-table"></span><span class="xn-text">Refill Request </span><label class="badge" id="rocount" style="background-color:green !important; margin-left: 10px; border-radius:90% !important"></label></a>
                    </li>
