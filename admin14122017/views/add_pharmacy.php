                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="panel-controls">
                                ...
                                <div class="container">
                                <form method="post" action="<?php echo site_url('pharmacy/add_pharmacy');?>" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <?php }?>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name="mobile_no" class="form-control" pattern="\d{10}" maxlength="10" title="Please  exactly 10 digits" required />
                                            </div>                                            
