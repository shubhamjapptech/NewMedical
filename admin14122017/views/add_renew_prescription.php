...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo site_url('PrescriptionControler/renew_prescription');?>">Refill Request</a></li>
    <li class="active">Add Renew Prescription</li>
</ul>
<!-- END BREADCRUMB -->
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-xs-12">   
                <div class="input-group">
                    ...
                    <input type="hidden" name="preQuantity" value="<?php echo $list->total_medicine;  ?>" />
                </div>                             
            </div>
            <div class="col-md-3 col-xs-12">  
                <div class="input-group"> 
