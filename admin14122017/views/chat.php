<?php $data['page']='seven'; $this->load->view('layout/chatheader',$data); ?>
        ...
        <div class="panel panel-primary">
          <div class="panel-body">
            ...
            <div class="col-md-5">
              ...
              <div id="mcs_container" class="col-md-7">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="img-place"><img src="<?php echo base_url(); ?>assest/chat/images/ajax-loader.gif" id="load-users"></div>
...
<!-- Image in large view  -->
<div class="modal fade" id="qbimageModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="background-color:rgba(0, 0, 0, 0.78);margin-top: 40px;">
    <div class="modal-dialog-md">
    <div class="modal-header" style="background:black !important; color:white;border-bottom:0px !important;">
...
<!--Qbimage Model Popup Start-->
<!--div class="modal fade" id="qbimageModal" role="dialog">
...
{
  var name = img.src;
  document.getElementById("showImg").innerHTML="<center><img class=img-responsive src='"+img.src+"' /></center>";
  //alert(name);
}
</script>
...
var QBApp = {
    appId: 60993,
    authKey: 'zrUP8-PrfrCfNT9',
    authSecret: 'V2sbb4W6-RXtzKt'
};
...
/*var QBUser1 = {
    ...
    var QBUser1 = {
        id: 26889668,
        name: 'Johnathan Pinkhasov',
        login: 'RepillHelpDesk',
        pass: 'Icenut77!'
    },*/
    var QBUser1 = {
        id: 32625198,
        name: 'RepillHelpDesk',
        login: 'repillrx@gmail.com',
        pass: '12345678'
    },
    /*var QBUser1 = {
        id: 29256192,
        name: 'Test lol',
        login: 'test1@test1.test',
        pass: 'Abc@12345'
    },*/
    QBUser2 = {
        id: 22407764,
