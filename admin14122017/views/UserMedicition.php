...
<?php  $data['page']='two'; $data['title']='Medication List'; $this->load->view('layout/header',$data);?>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Medication </strong> List</h3>
                                       ...
                                       <?php } if(isset($prescription1) && $prescription1!='') { 
                                        	...
                                        	foreach($prescription1 as $list) {
                                        		...
                                        		<tr>
                                                    ...
                                                    <td><?php echo date('m-d-Y',strtotime($list->end_date)); ?>
                                                    </td>                                                   
                                                    <td>
                                                        <a href="<?php echo site_url('PrescriptionControler/MedicineHistory?med_id='.$list->id.'&pres_id='.$pres_id.'&type='.$page.'&uid='.$list->user_id);?>">
