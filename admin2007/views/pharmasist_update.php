                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="panel-controls">
                                ...
                                <div class="container">
                                <form method="post" action="<?php echo site_url('pharmasist/update_pharmasist?id='.$pharma->id);?>" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <?php }?>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Enter Name</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">   
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="email" name="email" class="form-control" value="<?php echo $pharma->email; ?>" required />
                                            </div>                                            
                                        </div>
                                    </div>
