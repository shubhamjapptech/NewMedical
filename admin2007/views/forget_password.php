...
<html lang="en" class="body-full-height">
    ...
    <style>
        ...
        <!-- META SECTION -->
        <title>Repill Forget Password</title>            
        ...
        <div class="login-container">
            ...
            <?php } ?>
                ...
                <div class="login-body">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo site_url("admin/forget_password");?>">
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="text" name="email" class="form-control" placeholder="Enter Registred email_id" required />   
                            <span><?php echo form_error('email');?></span>                        
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-6">
                            <a href="<?php echo site_url('admin/login');?>" class="btn btn-link btn-block" style="font-size:16px; margin-top:20px;">Back to LogIn</a>
                        </div>>
