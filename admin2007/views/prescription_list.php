...
<?php $data['page']='five'; $data['title']='Prescriptions'; $this->load->view('layout/header',$data);?>
<style type="text/css">
    td,th{
        text-align:center;
    }
                                        ...
                                        <?php } if(isset($prescription1) && $prescription1!='') { 
                                            ...
                                            foreach($prescription1 as $list) {?>
                                                <tr>
                                                    ...
                                                    <td>                                                     
                                       <!--a href="<!?php echo site_url('PrescriptionControler/update_prescription?u_id='.$list->user_id.'&pres_id='.$list->prescription_id.'&med_name='.$list->medicine_name);?>">
                                       <i class="fa fa-pencil fa-fw"><strong>Edit Prescription</strong></i></a-->
                                       <a href="<?php echo site_url('PrescriptionControler/update_prescription?med_id='.$list->id.'&pres_id='.$list->prescription_id);?>">
                                       <i class="fa fa-pencil fa-fw"><strong>Edit Prescription</strong></i></a>
                                      </td> 
                                            <td>
                                             <a href="<?php echo site_url('PrescriptionControler/delete_prescription?med_id='.$list->id.'&pres_id='.$list->prescription_id);?>">
