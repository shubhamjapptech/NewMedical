...
<?php  $data['page']='five'; $data['title']='Update Prescriptions'; $this->load->view('layout/header',$data);?>
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                           ...
                           <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="<?php echo site_url('PrescriptionControler/update_prescription?med_id=').$list->id.'&pres_id='.$list->prescription_id; ?>">

                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Update</strong>Prescription</h3>
                                </div>
