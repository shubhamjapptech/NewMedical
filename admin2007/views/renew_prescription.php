...
<?php  
$data['page']='nine'; $data['title']='Renew Prescriptions Request'; $this->load->view('layout/header',$data);?>
<style type="text/css">
    td,th{
        text-align:center;
    }
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Renew Prescription</strong>Request</h3>
                             ...
                             <div class="alert alert-danger">
                                       ...
                                       <a href="<?php echo site_url('PrescriptionControler/add_renew_prescription?med_id='.$list->id.'&pres_id='.$list->prescription_id.'&med_name='.$list->medicine_name);?>">
