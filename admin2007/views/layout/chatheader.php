...
<html lang="en">
    <head>        
        ...
        <link rel="SHORTCUT ICON" href="http://repillrx.com/wp-content/uploads/2016/11/favicon.ico" type="image/png"/>
        <!-- END META SECTION -->
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-openable <?php if(isset($page) && $page=='two'){ echo 'active';}?>">
                        <a href="#" class="active"><span class="fa fa-user"></span> <span class="xn-text">Users</span><label class="badge" id="rowcount1" style="background-color:green !important; margin-left: 10px; border-radius:90% !important"></label></a>
                        <ul>
                            <li><a href="<?php echo site_url('user/insert_user');?>"><span class="fa fa-pencil"></span>Add Users</a></li>
                            <li><a href="<?php echo site_url('user/userlist');?>"><span class="fa fa-sort-alpha-desc"></span>Get UserList</a></li>
                        </ul>
                    </li>
...
function popupremove()
{
    $('#myModal').modal('hide');
    $.ajax({
            url: "http://app.repillrx.com/NewMedical/medical/index.php/PrescriptionControler/popupremove",
...
{
    $.ajax({
        url: "http://app.repillrx.com/NewMedical/medical/index.php/PrescriptionControler/checkprescription",
...
function checkuser() {
            $.ajax({
                url: "http://app.repillrx.com/NewMedical/medical/index.php/user/checkuser",
...
function checkpopup()
{
    $.ajax({
           dataType: "json",
            url: "http://app.repillrx.com/NewMedical/medical/index.php/PrescriptionControler/checkpopup",
            success: function (popup) 
            {
                console.log(popup);
                if(popup.name)
