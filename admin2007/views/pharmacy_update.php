                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Enter Your Pharmacy Name</label>
                            ...
                            <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Enter Full Name</label>
                                        <div class="col-md-6 col-xs-12">     
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Enter Father Name</label>
                                        <div class="col-md-6 col-xs-12">     
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">   
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="email" name="email" value="<?php echo $pharmacy->email_id; ?>" class="form-control" required />
                                            </div>                                            
                                        </div>
                                    </div>
