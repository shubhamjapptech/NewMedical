...
<html lang="en" class="body-full-height">
    ...
    <body>
        ...
        <div class="login-container">
            ...
            <?php } ?>
                <div class="login-logo"><img src="<?php echo base_url('assest/img/default1.jpg'); ?>" style="border-radius:15%;"></div>
                ...
                <div class="login-footer">
                    <div class="pull-right">
                        <a href="http://repillrx.com/about-us">About</a> |
                        <a href="http://repillrx.com/privacy-policy">Privacy</a> |
                        <a href="http://repillrx.com/support/contact">Contact Us</a>
                    </div>
                </div>
            </div>
